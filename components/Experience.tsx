              ...
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                  <img 
                    ...
                    className={`w-8 h-8 md:w-10 md:h-10 object-contain ${job.company !== 'Meredith' && job.company !== '23andMe' ? 'rounded-full' : ''}`}
                  />
                  <h4 className="text-lg md:text-xl font-medium text-orange">
                    {job.company}
                  </h4>
                </div>
                <span className="text-sm md:text-base text-navy/60 dark:text-offwhite/60 whitespace-nowrap">
                  {job.period}
                </span>
              </div>
